...
> ✅ EJU 官方扫描卷导入本地完成（2026-06-29）：在独立 worktree `feat/eju-official-exam-import` 上新增 scan-browser 模式，并继续把部分扫描卷升级为可作答 + 可判分。当前新增 graded practice：総合科目 2025-1 / 2023-2 / 2022-1、理科 2025-1；既有 総合科目 2024-1 和理科 2021-1 至 2023-2 继续可判分。`science/2019-1` 因扫描索引 `status=fail` 保持建设中；无可靠答案来源或页码映射的旧卷保持 scan-browser / `needs_review`。本轮未 deploy、未 push、未写 R2/D1、未调用 DeepSeek/Google Translate/Runtime AI、未触碰 JMdict Top 50K dirty worktree。
...
| 総合科目扫描卷 | ✅ 本地完成，待推送/部署 | 2024-1 为金标准正式练习；本轮新增 2025-1 / 2023-2 / 2022-1 graded practice；2018-1、2018-2、2019-1、2020-2、2021-1、2021-2、2022-2、2023-1 保持 scan-browser / needs_review |
| 理科扫描卷 | ✅ 本地完成，待推送/部署 | 已有 2021-1、2021-2、2022-1、2022-2、2023-1、2023-2 正式练习不变；本轮新增 2025-1 graded practice；2018-1、2018-2、2020-2、2024-1 保持 scan-browser / needs_review |
