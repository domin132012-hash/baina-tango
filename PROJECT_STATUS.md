...
> 当前线上版本：`20260613-rika-2023-1b`（commit a7f2925）。
> ⏳ **未完成（被打断，不算已做）**：理科 2023-1 样板的 3 个体验问题（导航按解答番号 / 裁底部空白 / 拆一页两题），详见 HANDOVER 第 5.A 节 + `task_plan.md`。
