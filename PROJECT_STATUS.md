...
**剩余 10 套**（未做）：2022-1/2、2021-1/2（有答案表）；2018-1/2、2019-1、2020-2、2024-1、2025-1（答案在试卷最后一页，做前先验证）。每套需：读答案表+读图定页码体系（含双题页/分科边界）+写proto+预览验证修正。属多会话工程。

**未部署**（用户要求确认后再 commit/push）。
