...
function buildCritiquePrompt(input) {
  ...
  return [
    ...
    "字数规则：400〜500 字为合格；350〜399 普通分上限 35；300〜349 上限 30；250〜299 上限 25；250 未满上限 20。",
    "如果字数合格、题目回应完整、观点明确、结构完整、有具体例且 high 错误 ≤1，则普通評価不应低于40，严格評価不应低于35。",
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const prompt = buildCritiquePrompt(Object.assign({}, body, { essay, essayCharCount: charCount }));
