...
SETS = {
    ...
    "2021-1": {
        "src": f"{EJU}/EJU理综/2021令和3年第1回理科.pdf",
        # 2前置说明页→物理4-22, 化学常数表24+题25-38, 生物39-54(含说明+問1)
        "pages": list(range(4, 23)) + [24] + list(range(25, 39)) + list(range(39, 55)),
    },
    "2021-2": {
        "src": f"{EJU}/EJU理综/2021令和3年第2回理科.pdf",
        # 2前置说明页→物理4-22, 化学常数表24+题25-38, 生物39-55(含说明+問1)
        "pages": list(range(4, 23)) + [24] + list(range(25, 39)) + list(range(39, 56)),
    },
}
